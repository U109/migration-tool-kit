...
import com.zzz.migration.entity.migrationObjEntity.DataBaseConnEntity;
...
public class TaskDetail implements Serializable, Cloneable {
    ...
    //源数据库对象
    private DataBaseConnEntity sourceDataBase;
    //目标数据库对象
    private DataBaseConnEntity targetDataBase;

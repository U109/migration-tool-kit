...
public abstract class AbstractSQLGenerator implements ISQLGenerator {
     ...
     * 构建列字符串
     */
    public String makeColumnContract(String identifier, List<TableColumn> columnList) {
        StringBuilder sb = new StringBuilder();
    ...
    public String makeTargetColumnString(String identifier, List<TableColumn> columnList) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < columnList.size(); i++) {
